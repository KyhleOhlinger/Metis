 ...
 *   makeInlinePreviewExtension — inline images (+ reveal menu), GFM tables + sticky notes collapse to rendered preview when the caret is outside (click to edit), sticky drag-drop, Cmd/Ctrl+click links
 */
